...
// 查找起始坐标跳过点,加速查找起始坐标
define('SKIP_START_COLUMN', 826);
define('SKIP_START_ROW', 334);
// 游戏区域大小，根据自己的实际游戏窗口大小调整
define('GAME_ARE_WIDTH', 928);//930
define('GAME_ARE_HEIGHT', 550);//554
//游戏窗口误差
define('GAME_ARE_LIMIT', 0);
// 游戏背景颜色RGB，用来查找游戏区域
define('GAME_BACKGROUND_COLOR', [249, 249, 249]);
// 颜色相似误差值
